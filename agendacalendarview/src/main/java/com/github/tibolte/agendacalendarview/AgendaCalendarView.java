...
public class AgendaCalendarView extends FrameLayout implements StickyListHeadersListView.OnStickyHeaderChangedListener {
    ...
    private android.support.design.widget.FloatingActionButton mFloatingActionButton, mFloatingActionButtonAddEvent;
    ...
    protected void onFinishInflate() {
        ...
        mFloatingActionButtonAddEvent = (android.support.design.widget.FloatingActionButton) findViewById(R.id.floating_action_button_add_event);
        ...
        mFloatingActionButtonAddEvent.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                mCalendarPickerController.onFloatingButtonAddEventClick();
            }
        });

        mAgendaView.getAgendaListView().setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            @Override
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                CalendarEvent event = CalendarManager.getInstance().getEvents().get(position);
                mCalendarPickerController.onEventLongPress(event);
                return true;
            }
        });
